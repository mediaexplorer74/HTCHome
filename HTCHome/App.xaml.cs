...
namespace HTCHome
{
    ...
    public partial class App : Application
    {
        ...
        private void ApplicationStartup(object sender, StartupEventArgs e)
        {
            try
            {
                //Check if we must run as administrator (Admin mode with high privelegues)
            ...
            {
                Debug.WriteLine("ApplicationStartup Exception: " + ex.Message);
        ...
        {
            // RnD: try to remove the Tray Icon
            RemoveTrayIcon();
